  ...
  return (
    <nav className='fixed top-0 w-full h-14 flex items-center justify-between text-white bg-black text-sm md:text-lg lg:text-md'>
      <ul className='flex items-center md:gap-4 lg:gap-4'>
        <li className='flex items-center mr-2 md:mr-8 lg:mr-8'>
        ...
        <li><Link to='/teams' className='font-archivo mr-4 md:mr-8 lg:mr-8 hover:text-neutral-300'>TEAMS</Link></li>
        <li><Link to='/games' className='font-archivo mr-4 md:mr-8 lg:mr-8 hover:text-neutral-300'>GAMES</Link></li>
      </ul>
