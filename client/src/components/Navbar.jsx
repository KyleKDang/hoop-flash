...
const Navbar = () => {
  ...
  return (
    <nav className='fixed top-0 w-full h-14 flex items-center justify-between text-white bg-black text-sm lg:text-md'>
      <ul className='flex items-center lg:gap-4'>
        <li className='flex items-center mr-2 lg:mr-8'>
          <Link to='/'><img src='/hoopflash/hoopflash-logo-black.png' alt='hoopflash logo' className='h-8 lg:h-12'/></Link>
          <img src='/hoopflash/lightning-bolt.png' alt='lightning bolt'className='h-5 lg:h-7'/>
        </li>
      ...
      <ul className='flex mr-2 lg:mr-4 gap-4 lg:gap-8'>
